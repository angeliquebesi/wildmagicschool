...
export default function Spell() {
  return (
    ...
    <div>
      <body className="spellbackground">
        ...
        <main>
          ...
          <div className="spell-card">
            <div className="spell-card__inner">
              <div className="spell-card__shape">
                <div className="spell-card__trace" style={{ backgroundImage: "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/arresto.svg')" }} />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 166.02 168.22">
                  ...
                  <polyline clipPath="url(#clip-arresto)" className="trace-motion" fill="none" stroke="#ddfffb" strokeMiterlimit="10" strokeWidth="14" points="0 168.22 33 7.22 83 159.22 133 7.22 151 84.22 166 163.22" />
                </svg>
          ...
          <div className="spell-card">
            <div className="spell-card__inner">
              <div className="spell-card__shape">
                <div className="spell-card__trace" style={{ backgroundImage: "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/meteo.svg')" }} />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184 101.5">
                  ...
                  <path clipPath="url(#clip-meteo)" className="trace-motion" fill="none" stroke="#ddfffb" strokeMiterlimit="10" strokeWidth="10" d="M107.41,174.11S112,125,163,125s52,45.22,54,49.11c0,0,2-84.11-92-96.11,0,0-80,2.15-91.51,88.07" transform="translate(-33 -74.25)" />
                </svg>
          ...
          <div className="spell-card">
            <div className="spell-card__inner">
              <div className="spell-card__shape">
                <div className="spell-card__trace" style={{ backgroundImage: "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/expecto.svg')" }} />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182.37 169.75">
                  ...
                  <path clipPath="url(#clip-expecto)" className="trace-motion" fill="none" stroke="#ddfffb" strokeMiterlimit="10" strokeWidth="10" d="M155,92s49,94-49,97c0,0-62-6-65-78,0,0,7-63,54-73,0,0,29-18,76,4,0,0,58,26,41,111,0,0-9,31-17,30" transform="translate(-36.27 -26.47)" />
                </svg>
          ...
          <div className="spell-card">
            <div className="spell-card__inner">
              <div className="spell-card__shape">
                <div className="spell-card__trace" style={{ backgroundImage: "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/ridi.svg')" }} />
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 159.22 187.39">
                  ...
                  <path clipPath="url(#clip-ridi)" className="trace-motion" fill="none" stroke="#ddfffb" strokeMiterlimit="10" strokeWidth="10" d="M207.22,33.9,123,120,54,45l3,85s-4,50,21,68,65,19,75,13c0,0,37.94-17.47,44.47-42.23" transform="translate(-48 -32.61)" />
                </svg>
